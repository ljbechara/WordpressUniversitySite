...
get_header();
	...
	<div class="container container--narrow page-section">
		...
		<?php 
			...
			$relatedPrograms = get_field('related_programs'); // esta funcion devuelve un array
			//print_r($relatedPrograms); // para visualizar detalladamenete la estructura de la variable
			if ($relatedPrograms){
