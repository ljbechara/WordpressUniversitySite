...
/* harmony import */ var _modules_Search__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/Search */ "./src/modules/Search.js");
 ...
 // slideshow que se muestra abajo en el frontpage
...
class Search {
  ...
  constructor() {
    ...
    this.closeButton = jquery__WEBPACK_IMPORTED_MODULE_0___default()(".search-overlay__close"); // selecciono el icono X por la clase
  ...
  getResults() {
    jquery__WEBPACK_IMPORTED_MODULE_0___default().getJSON(universityData.root_url + '/wp-json/wp/v2/posts?search=' + this.searchField.val(), posts => {
      //dentro del .html utilizamos template literal `` que permite multiples lineas en javascript
      // no permite utilizar IF dentro
      this.resultsDiv.html(` 
				<h2 class="search-overlay__section-title">General Information</h2>
				${posts.length ? '<ul class="link-list min-list">' : '<p>No general information matches</p>'}
  ...
  openOverlay() {
    ...
    this.resultsDiv.html('');
    setTimeout(() => this.searchField.focus(), 301); // es lo mismo que setTimeout( function () { this.searchField.focus(); } ,301);  
